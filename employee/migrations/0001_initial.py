...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='CurruntOrderState',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('time', models.IntegerField(db_column='TIME')),
                ('field_1', models.BigIntegerField(blank=True, db_column='_1', null=True)),
                ('field_2', models.BigIntegerField(blank=True, db_column='_2', null=True)),
                ('field_3', models.BigIntegerField(blank=True, db_column='_3', null=True)),
                ('field_4', models.BigIntegerField(blank=True, db_column='_4', null=True)),
                ('field_5', models.BigIntegerField(blank=True, db_column='_5', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='OrderList',
            fields=[
                ('field_id', models.BigAutoField(db_column='_id', primary_key=True, serialize=False)),
